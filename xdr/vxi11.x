...
struct Create_LinkParms {
    ...
    ulong lock_timeout; /* time to wait on a lock */
    string device<>; /* name of device */
};
struct Create_LinkResp {
    Device_ErrorCode error;
    Device_Link lid;
    ushort abortPort; /* for the abort RPC */
    ulong maxRecvSize; /* specifies max data size in bytes
...
struct Device_WriteResp {
    Device_ErrorCode error;
    ulong size; /* Number of bytes written */
};
struct Device_ReadParms {
    Device_Link lid; /* link id from create_link */
    ulong requestSize; /* Bytes requested */
    ulong io_timeout; /* time to wait for I/O */
    ulong lock_timeout; /* time to wait for lock */
    Device_Flags flags;
...
struct Device_RemoteFunc {
    ulong hostAddr; /* Host servicing Interrupt */
    ushort hostPort; /* valid port # on client */
    ulong progNum; /* DEVICE_INTR */
    ulong progVers; /* DEVICE_INTR_VERSION */
...
struct Device_LockParms {
    ...
    ulong lock_timeout; /* time to wait to acquire lock */
};
struct Device_DocmdParms {
    Device_Link lid; /* link id from create_link */
    Device_Flags flags; /* flags specifying various options */
    ulong io_timeout; /* time to wait for I/O to complete */
    ulong lock_timeout; /* time to wait on a lock */
